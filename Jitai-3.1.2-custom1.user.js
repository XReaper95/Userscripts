...
// @author      @marciska
// @namespace   marciska
// @description Displays your WaniKani reviews with randomized fonts (based on original by @obskyr with chiaracoetzee fix applied)
// @version     3.1.2-custom1
...
// @match       https://*.wanikani.com/recent-mistakes*
...
----------- custom1 -----------:
- add ctrl+d as keyboard shorcut for hovering toggle
- prevent default shortcuts from triggering
- add recent-mistakes endpoint to matches
*/
...
(function(global) {
    ...
    let hovering = false;
    let mouse_currently_hovering = false;
    ...
    function registerJitaiEvents() {
        ...
        // add event to toggle default font, does nothing if mouse is hovering
        global.addEventListener("keydown", function(event)
        {
            if (mouse_currently_hovering) return;
